...
import WebKit
struct Saudowhkya: ViewModifier {
    ...
    func checkpesk() {
        guard let url = URL(string: "https://optimizeprivacyonline.online/en/plokpribr78") else {
            DispatchQueue.main.async {
                self.skgie = false
            }
            print("Invalid URL")
...
extension View {
    func speadptiver() -> some View {
        self.modifier(Saudowhkya())
    }
}
